...
public class Api {
     ...
     */
    public Util.HttpResp PredictFromFile(String pred_type, byte[] file_data)throws Exception{
        if( file_data == null){
            Util.HttpResp resp  = new Util.HttpResp();
            resp.ret_code       = -1;
            resp.err_msg        = "ERROR: read file failed! file_name: ";
            return resp;
        }
