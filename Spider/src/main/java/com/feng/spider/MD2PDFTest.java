...
public class MD2PDFTest {
    ...
    public static void main(String[] args) throws ConversionException, Markdown2PdfLogicException {
        MD2PDFTest md2PDFTest = new MD2PDFTest();
        md2PDFTest.basicExample();
    }
    ...
    public void basicExample() throws Markdown2PdfLogicException, ConversionException {
         ...
         */
        markdown2PdfConverter.readFrom(() -> "test.md");
         ...
         */
        markdown2PdfConverter.writeTo(out -> System.out.println(out));
